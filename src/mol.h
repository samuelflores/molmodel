...
static const MolResidueNames mol_res_names[] = {
  [MOL_RESIDUE_UNKNOWN] =        {"unknown",        "unknown", ' ', MOL_RESIDUE_UNKNOWN},
  [MOL_RESIDUE_ALANINE] =        {"alanine",        "ala",     'a', MOL_RESIDUE_ALANINE},
  [MOL_RESIDUE_ARGININE] =       {"arginine",       "arg",     'r', MOL_RESIDUE_ARGININE},
  [MOL_RESIDUE_ASPARAGINE] =     {"asparagine",     "asn",     'n', MOL_RESIDUE_ASPARAGINE},
  [MOL_RESIDUE_ASPARTIC_ACID] =  {"aspartic acid",  "asp",     'd', MOL_RESIDUE_ASPARTIC_ACID},
  [MOL_RESIDUE_CYSTEINE] =       {"cysteine",       "cys",     'c', MOL_RESIDUE_CYSTEINE},
  [MOL_RESIDUE_GLUTAMIC_ACID] =  {"glutamic acid",  "glu",     'e', MOL_RESIDUE_GLUTAMIC_ACID},
  [MOL_RESIDUE_GLUTAMINE] =      {"glutamine",      "gln",     'q', MOL_RESIDUE_GLUTAMINE},
  [MOL_RESIDUE_GLYCINE] =        {"glycine",        "gly",     'g', MOL_RESIDUE_GLYCINE},
  [MOL_RESIDUE_HISTIDINE] =      {"histidine",      "his",     'h', MOL_RESIDUE_HISTIDINE},
  [MOL_RESIDUE_ISOLEUCINE] =     {"isoleucine",     "ile",     'i', MOL_RESIDUE_ISOLEUCINE},
  [MOL_RESIDUE_LEUCINE] =        {"leucine",        "leu",     'l', MOL_RESIDUE_LEUCINE},
  [MOL_RESIDUE_LYSINE] =         {"lysine",         "lys",     'k', MOL_RESIDUE_LYSINE},
  [MOL_RESIDUE_METHIONINE] =     {"methionine",     "met",     'm', MOL_RESIDUE_METHIONINE},
  [MOL_RESIDUE_PHENYLALANINE] =  {"phenylalanine",  "phe",     'f', MOL_RESIDUE_PHENYLALANINE},
  [MOL_RESIDUE_PROLINE] =        {"proline",        "pro",     'p', MOL_RESIDUE_PROLINE},
  [MOL_RESIDUE_SERINE] =         {"serine",         "ser",     's', MOL_RESIDUE_SERINE},
  [MOL_RESIDUE_THREONINE] =      {"threonine",      "thr",     't', MOL_RESIDUE_THREONINE},
  [MOL_RESIDUE_TRYPTOPHAN] =     {"tryptophan",     "trp",     'w', MOL_RESIDUE_TRYPTOPHAN},
  [MOL_RESIDUE_TYROSINE] =       {"tyrosine",       "tyr",     'y', MOL_RESIDUE_TYROSINE},
  [MOL_RESIDUE_VALINE] =         {"valine",         "val",     'v', MOL_RESIDUE_VALINE},
  [MOL_RESIDUE_SOLV] =           {"solvent",        "sol",     'h', MOL_RESIDUE_SOLV},
  [MOL_RESIDUE_ADP] =            {"adp",            "adp",     'h', MOL_RESIDUE_ADP},
  [MOL_RESIDUE_CHLORINE] =       {"cl",             "cli",     'h', MOL_RESIDUE_CHLORINE},
  [MOL_RESIDUE_HOH] =            {"hoh",            "hoh",     'h', MOL_RESIDUE_HOH},
  [MOL_RESIDUE_ADENOSINE] =      {"adenosine",      "adn",     'A', MOL_RESIDUE_ADENOSINE},
  [MOL_RESIDUE_GUANOSINE] =      {"guanosine",      "gua",     'G', MOL_RESIDUE_GUANOSINE},
  [MOL_RESIDUE_CYTOSINE] =       {"cytosine",       "cyt",     'C', MOL_RESIDUE_CYTOSINE},
  [MOL_RESIDUE_URIDINE] =        {"uridine",        "ura",     'U', MOL_RESIDUE_URIDINE},
  [MOL_RESIDUE_THYMINE] =        {"thymine",        "thy",     'T', MOL_RESIDUE_THYMINE},
  [MOL_RESIDUE_URIDINE2] =       {"uridine",        "h2u",     'U', MOL_RESIDUE_URIDINE2},
  [MOL_RESIDUE_CYTOSINE2] =      {"cytosine",       "omc",     'C', MOL_RESIDUE_CYTOSINE2},
  [MOL_RESIDUE_GUANOSINE2] =     {"guanosine",      "omg",     'G', MOL_RESIDUE_GUANOSINE2},
  [MOL_RESIDUE_URIDINE3] =       {"uridine",        "psu",     'U', MOL_RESIDUE_URIDINE3},
  [MOL_RESIDUE_CYTOSINE3] =      {"cytosine",       "5mc",     'C', MOL_RESIDUE_CYTOSINE3},
  [MOL_RESIDUE_GUANOSINE3] =     {"guanosine",      "7mg",     'G', MOL_RESIDUE_GUANOSINE3},
  [MOL_RESIDUE_URIDINE4] =       {"uridine",        "5mu",     'U', MOL_RESIDUE_URIDINE4},
  [MOL_RESIDUE_ADENOSINE2] =     {"adenosine",      "1ma",     'A', MOL_RESIDUE_ADENOSINE2},
  [MOL_RESIDUE_GUANOSINE4] =     {"guanosine",      "2mg",     'G', MOL_RESIDUE_GUANOSINE4},
  [MOL_RESIDUE_GUANOSINE5] =     {"guanosine",      "m2g",     'G', MOL_RESIDUE_GUANOSINE5},

  // scf added DNA residues
  [MOL_RESIDUE_DEOXYADENOSINE] = {"deoxyadenosine", "da",      'A', MOL_RESIDUE_DEOXYADENOSINE},
  [MOL_RESIDUE_DEOXYGUANOSINE] = {"deoxyguanosine", "dg",      'G', MOL_RESIDUE_DEOXYGUANOSINE},
  [MOL_RESIDUE_DEOXYCYTOSINE] =  {"deoxycytosine",  "dc",      'C', MOL_RESIDUE_DEOXYCYTOSINE},
  [MOL_RESIDUE_DEOXYTHYMINE] =   {"deoxythymidine", "dt",      'T', MOL_RESIDUE_DEOXYTHYMINE},

  //
  [MOL_RESIDUE_DISULPHIDEBRIDGEDCYSTEINE] = {"disulphidebridgedcysteine",      "cyx",     'x', MOL_RESIDUE_DISULPHIDEBRIDGEDCYSTEINE},

  // terminator
  [MOL_RESIDUE_MAX_NUM] = {{'\0'},                  {'\0'},   '\0', MOL_RESIDUE_UNKNOWN}};
...
typedef struct MolChain {
  char *name;
  char id; // maybe add char long_chain_id
  //std::string long_chain_id;
  char * long_chain_id;
...
void 
mol_DbPdbAtomProcLongChainId (FILE *fp, char *line, MolModel *model, std::string longChainId = " "),
...
void
//mol_ChainResiduesGet (std::vector<MolChain> & chain, int *p_num, MolResidue ***p_list);
mol_ChainResiduesGet (MolChain *chain, int *p_num, MolResidue ***p_list);

void 
mol_DbRead (const char *name, const char *file_name, MolDbType db_type, MolModel **p_model); //, std::vector<std::string> deletedResidueVector = std::vector<std::string>()) ; // 5th parameter is optional, defaults to an empty vector<string>
...
char * 
mol_StrCopy( const char * source, MolModel* model );
...
//mol_StructureAtomsGet (MolStructure *struc, int *p_num, std::vector<MolAtom> & p_atoms);
